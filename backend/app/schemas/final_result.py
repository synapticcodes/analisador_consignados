"""
FinalResult schemas - Pydantic models para os 6 outputs finais
"""
...
class MonetaryField(BaseModel):
    ...
    Formato padrão para os 6 outputs principais.
    """
...
class FinalResultResponse(BaseModel):
    """
    Response com os 6 outputs finais consolidados.
